...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yosupo-fps/yosupo-inv-of-formal-power-series-fps998.test.cpp\"\
    ...
    #line 6 \"fps/detail/fps998_inv.hpp\"\n#include <cstring>\n#line 8 \"fps/detail/fps998_inv.hpp\"\
    ...
    \        throw std::invalid_argument(\n            \"eez::fps998::inv_to: constant\
    \ term must be nonzero\"\n        );\n\n    if(out.size()>max_size)\n        throw\
    \ std::length_error(\n            \"eez::fps998::inv_to: result exceeds the 2^25\
  ...
  requiredBy: []
  timestamp: '2026-09-07 02:48:08+09:00'
